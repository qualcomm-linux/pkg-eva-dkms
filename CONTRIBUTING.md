...
1. [Fork](https://github.com/qualcomm-linux/pkg-eva-dkms/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-eva-dkms.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-eva-dkms.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-eva-dkms/pulls) from your branch to `main`.
