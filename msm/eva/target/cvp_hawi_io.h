...
#define CVP_WRAPPER_CVP_NOC_LPI_CONTROL		(CVP_WRAPPER_BASE_OFFS + 0x120)
#define CVP_WRAPPER_CVP_NOC_LPI_STATUS		(CVP_WRAPPER_BASE_OFFS + 0x124)
#define CVP_WRAPPER_CVP_NOC_CX_LPI_CONTROL		(CVP_WRAPPER_BASE_OFFS + 0x128)
#define CVP_WRAPPER_CVP_NOC_CX_LPI_STATUS		(CVP_WRAPPER_BASE_OFFS + 0x12C)
...
#define CVP_CC_AHB_CBCR				(CVP_CC_BASE_OFFS + 0x9C)
#define CVP_CC_SLEEP_CBCR			(CVP_CC_BASE_OFFS + 0xE0)
#define CVP_CC_XO_CBCR			(CVP_CC_BASE_OFFS + 0xCC)
...
#define CVP_CC_MVS0C_FREERUN_CBCR		(CVP_CC_BASE_OFFS + 0x60)
#define CVP_CC_DBGCH_XO_CBCR			(CVP_CC_BASE_OFFS + 0xD4)
#define CVP_CC_CC_MVS0C_CTL_FREERUN_CBCR (CVP_CC_BASE_OFFS + 0x64)
